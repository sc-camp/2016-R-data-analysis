    ...
    \begin{enumerate}
      ...
      \item On the cluster\\
       First connect to the cluster, then submit a job to run R.
        \begin{cmdline}
            \cmdlinelocal{ssh cluster}\\
            \cmdlinefrontend{salloc -p all --nodes=1 --partition=all srun --pty bash}\\
            \cmdlinenode{R}
        \end{cmdline}
...
\frame{
  \frametitle{Exercises}
    \begin{itemize}
      \item Start the tutorial \url{https://github.com/sc-camp/2016-R-data-analysis}
      \begin{itemize} 
